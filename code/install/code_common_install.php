 ...
 */
class code_common_install extends code_common {
    ...
    public $settings_insert_query = "INSERT INTO `settings` (`name`, `value`) VALUES
        ...
        ('help_format', 'html'),
        ('default_skin', ''),
        ('guest_pages', '[\"login\",\"guesthelp\",\"ranks\", \"index\"]');";
