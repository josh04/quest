...
class skin_ticket extends _skin_admin {
    ...
    * @param $ticket_status
    */
    public function ticket_colour($ticket_status) {
        $arr = array("FFFF99","99FF99","FF9999","FFFF99","FFFF99");
        return $arr[$ticket_status];
    }
    ...
    * @param $ticket_status
    */
    public function ticket_icon($ticket_status) {
        $arr = array("images/ticket_open.png","images/ticket_resolved.png","images/ticket_closed.png","images/ticket_working.png","images/ticket_ready.png");
        return $arr[$ticket_status];
    }
