...
function dragObject(element, attachElement, lowerBound, upperBound, startCallback, moveCallback, endCallback, attachLater, className, List)
{
  if(typeof(element) == "string")
    element = document.getElementById(element);
  if(element == null)
  ...
  function dragStart(eventObj)
  {
    ...
    if(startCallback != null)
      startCallback(eventObj, element, List);
  ...
  function dragGo(eventObj)
  {
    ...
    if(moveCallback != null)
      moveCallback(newPos, element, eventObj, className, List);
  ...
  function dragStop()
  {
    ...
    if(endCallback != null)
      endCallback(element, className, List);
    dragging = false;
  }
...
function itemDragBegin(eventObj, element, List)
{
...
function itemMoved(newPos, element, eventObj, className, List)
{
  eventObj = eventObj ? eventObj : window.event;
  ...
  {
    if(List.childNodes[i].className == className)
    {
...
function itemDragEnd(element, className, List)
{
